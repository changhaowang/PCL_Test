...
public:
  ...
  Recognition(ros::NodeHandle& nh):
    rec_pub(nh.advertise<sensor_msgs::PointCloud2> ("rec_output", 1))
    { }
  void init(ros::NodeHandle& nh, int argc, char** argv)
  {
    cloud_sub=nh.subscribe("camera/depth/points", 1, &Recognition::cloudCallback, this);
  }
  ...
  void cloudCallback(const sensor_msgs::PointCloud2ConstPtr& input)
  {
    ...
    //transform ros message to pointcloud type
